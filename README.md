# dockers_gcloud
### Build a docker image that streams twits to Mongodb base on location and word, run it on multiple vm with Kubernete cluster and query the Mongodb with RoboMongo and mLab.
