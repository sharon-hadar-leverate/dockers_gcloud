# dockers_gcloud
### Build a docker image that use twitter stream api to back twits to Mongodb base on location and run it on multiple vm with Kubernete cluster and run queries on it.
